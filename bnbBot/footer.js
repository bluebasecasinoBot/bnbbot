import { SYD_VAR, __SYD, __c , __p, __sC} from "./sydneyDom_v3.js";
import "./icon.js"
import "./text_lib.js"
...
__SYD.footer_main_parent = () =>{
    ...
    return __c(
        'div',
        {
            style:`height:fit-content;padding:${check ? "10px 50px" : "10px 10px"};padding-top:20px;padding-bottom:20px;width:100%;display:flex;flex-direction:column;row-gap:40px;padding-bottom:50px;position:relative;background-color:#1e1e1e;border-radius:20px;`+__sC["thinBorder"](),
            id:"footer"
        },
        [
            __c(
...
__SYD.footer_main_child2 = () =>{
    return __c(
        ...
        [
            __SYD.text_lib_type_h1_glob({cnt:'Socials' , size:'20px' , w:'700' , inject:'text-decoration:underline;',clr:'#F3BA2F'}),
            __c(
                'div',
                {
                    ...
                    __c(
                        'div',
                        {
                            ...
                            __c(
                                ...
                                [
                                    __SYD.iconify_20px({attr:'fa-brands fa-x-twitter' , clr :'#F3BA2F'}),//<i class="fa-solid fa-envelope-open-text"></i>
                                    __c('a',{href:"https://x.com/bnbbot_botb?s=21"},[__SYD.text_lib_type_p_glob_vmax({cnt:'Twitter', size:'14px' , w:'500',clr:'#F3BA2F'})]),
                                ]
                            ),
                            ...
                            __c(
                                ...
                                [
                                    ...
                                    __c('a',{href:"http://t.me/BNBBOT_BSC_bot"},[__SYD.text_lib_type_p_glob_vmax({cnt:'Telegram', size:'14px' , w:'500',clr:'#F3BA2F'})]),
                                ]
                            ),
