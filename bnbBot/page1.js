    ...
    return  __c(
        ...
        [
            ...
            __c(
                "div",
                {
                    style:`${__p(["p1SubHeader" , "breakVal"],false) ? "height:300px;width:300px" : "height:500px;width:500px"};display:flex;flex-direction:column;gap:20px;background-position:center 0;border-radius:0%;background-image:url(./assets/main.png);`,
                    // class:"floatMainPic"
                },[
                    // __c(
...
__SYD.p1_subText = () =>{
    return __c(
        ...
        [
            __c("p" , {style:SYD_VAR.pag1SubText.get() + "padding:10px;color: #FFFFFF ;" , class:"target_div"},["Meet Bnbbot — the fastest way to trade crypto directly in Telegram. Simple, secure, and built for traders who want speed, control, and results.”"])
        ]
    )
}
